...
```{r plateau-view, fig.cap="One mile in from the trailhead. The plateau stretches flat in every direction.", out.width="100%", fig.fullwidth=TRUE}
...
**Water shoes.** The group was split on this. Some brought dedicated water shoes, some carried an extra pair alongside their hiking boots, and few of us (myself included) just used a single pair of walking shoes throughout, creek crossings and all. It worked fine. The crossings are manageable in good trail shoes; water shoes make it more comfortable but are not strictly essential.
