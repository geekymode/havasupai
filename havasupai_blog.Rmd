...
Some images stay with you for no particular reason. Years ago I came across a photograph of blue-green water against deep red canyon walls, and it lodged somewhere in the back of the mind the way certain images do. Not an obsession, just a quiet recurring thought: *that place is real, and it would be something to see it.* Havasupai permits are notoriously hard to get. They open once a year, sell out within hours, and for a group of twelve the odds are not flattering. We got ours on the first try, which felt less like a reward for planning and more like the universe deciding to cooperate on a particular Tuesday morning in February. We were not going to argue with it.
...
```{r plateau-view, fig.cap="One mile in from the trailhead. The plateau stretches flat in every direction and the canyon is completely invisible until you walk to the edge.", out.width="100%", fig.fullwidth=TRUE}
...
At the trailhead I got talking with one of the tribal employees, a friendly, sharp-witted man who seemed thoroughly entertained by twelve people from San Diego nervously adjusting their pack straps. He was generous with information: great weather ahead, he said, and the colour of the water right now was as good as it gets. He also taught me a handful of phrases in Supai, the tribal language. [*Gam'yu*](https://www.bigorrin.org/havasupai_kids.htm) ("gahm-yoo") is a friendly greeting, and the one I am most confident I have spelled correctly. He also shared rough equivalents of thank you and how are you, which I attempted to repeat with varying degrees of accuracy and which he received with considerable patience and visible amusement.
...
That evening at the lodge involved a long session of Impostor (Among Us, the physical card version) that, as these games tend to, revealed unexpected sides of people's personalities. The accusations were spirited. No one admitted to anything.
...
```{r bloodmoon, fig.margin=TRUE, fig.cap="The blood moon of March 3, 2025, photographed from the canyon floor at 4 a.m. Zero light pollution, total silence, and twelve Trailblazers staring up in the dark.", out.width="100%"}
...
`r margin_note("**Permit tips** <br> The Havasupai permit system opens in early February each year. Demand is extremely high; permits sell out within hours. Check havasupaireservations.com for cancellation releases. For a group of 12, have multiple people trying simultaneously.")`

<div class="box-blue">
**Permits.** Obtained through the [Havasupai Tribe's reservation system](https://www.havasupaireservations.com). Permits sell out within hours of opening. For a group of 12, it takes coordination and some luck. Cancellations do get released throughout the season, so it is worth checking back regularly if you miss the initial opening.

**The drive.** From San Diego the drive is around 5–6 hours depending on your stop. Indian Route 18 off Route 66 is the last stretch, 65 miles on a remote two-lane road. Fill up the gas tank before you turn off the highway.

**Start time.** We started at 12:30 p.m., which is on the later side, and arrived at the lodge just around dark. A dawn or early-morning start is smarter: it is cooler and you arrive with daylight to spare for swimming.
...
**Flash flooding.** The canyon is susceptible to flash floods from storms far upstream that you will never see. Pay attention to the tribe's guidance and any warnings. The 2008 flood reshaped the canyon in a matter of hours.

**Pack out everything.** The tribe's rules are legally binding and ecologically necessary. The creek has already shown stress from visitor impact. Leave nothing.
</div>
